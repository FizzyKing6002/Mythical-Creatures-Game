...
{
	var _identifier = _details.identifier;
	...
	var _data = get_move_data(_identifier);
	
	_combatMove.identifier = _identifier;
	...
	var _moveSprite = get_move_sprite_by_identifier(_identifier);
